...
- Project description: penjualan toko kue
...
- Docker strategy: Docker for both development and production
...
Selected Docker strategy: Docker for both development and production
...
- Required asset floor: .dockerignore, compose.yaml for development, compose.prod.yaml or a documented production Compose override, Dockerfile stage(s) derived from the actual stack, docs/docker-runtime.md or a deployment runbook with ports, entrypoints, health checks, and source URLs.
